* *Packages not using the default build ﬂags: a taxonomy* (http://www.linux.it/~ema/slides/nocflags_slides.pdf[slides], https://peertube.debian.social/w/vRqQD8rWKMZhTmfJQ8dLrH[video]) +
