* *Packages not using the default build ﬂags: a taxonomy* (http://www.linux.it/~ema/slides/nocflags_slides.pdf[slides], https://mirror.accum.se/pub/debian-meetings/2025/DebConf25/debconf25-628-packages-not-using-the-default-build-flags-a-taxonomy.av1.webm[video]) +
2025-07-15, Debconf 25, Brest, France

* *Enabling Architectural Features in Debian: PAC and BTI on arm64* (http://www.linux.it/~ema/slides/pacbti.pdf[slides], https://fosdem.org/2025/schedule/event/fosdem-2025-5517-enabling-architectural-features-in-debian-pac-and-bti-on-arm64/[video]) +
